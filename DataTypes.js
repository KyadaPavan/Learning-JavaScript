...
let d = BigInt(458624); // Bigint define any larger numeric value
let e = "Pavan" ;  // String defines multiple character
let f = Symbol("This is a symbol");  // It is used to define any symbol
let g ; // If we don't pass any value to the variable it is by default undefined

console.log(a,b,c,d,e,f,g);
console.log(typeof e); // typeof returns which type of data type it is
